<template>
  <div v-if="this.hasPermission">
    ...
    <div v-else class="flex flex-col justify-center items-center w-full min-h-[80vh] gap-4">
      ...
      <div id="user-playlist" class="max-w-sm md:min-w-min md:max-w-md space-y-2">
        <div class="flex flex-row h-24 bg-neutral-700 p-2 rounded-md" v-for="track in this.currentPlaylist"
          :key="track.id">
  ...
  <div v-else>
    <a href="/api/auth/permission">grant permission to access your playlists</a>
  </div>
</template>
